/*
 * FileUploadEntryAction.java
 *
 * Created on September 20, 2006, 6:58 PM
 *
...
public class FileUploadEntryAction extends Action {
...
//--------------------------------------------------------------------------------
// Unable to use Formatter to populate the FileUploadForm due to the
// FormFile object required by the Struts file upload action.
//--------------------------------------------------------------------------------
      FileUploadForm formStr = new FileUploadForm();
      formStr.setSourceTypeKey(sourceTypeKey.toString());
      formStr.setSourceKey(sourceKey.toString());
      formStr.setSourceName(sourceName);
      form = formStr;
