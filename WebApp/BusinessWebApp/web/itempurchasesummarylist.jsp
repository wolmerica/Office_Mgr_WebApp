...
<!-- Item Purchase History by vendor, customer, scenario, manufacturer and date range -->
    <td colspan = "7">
      <html:form action="ItemPurchaseSummaryList.do">
  ...
  <tr align="left">
    <th><bean:message key="app.itempurchase.invoiceYear" /></th>    
    <th><bean:message key="app.itempurchase.invoiceMonthName" /></th>
    <th align="right"><bean:message key="app.itempurchase.transactionCnt" /></th>       
    <th align="right"><bean:message key="app.itempurchase.useTaxCost" /></th>  
    <th align="right"><bean:message key="app.itempurchase.handlingCost" /></th>            
    <th align="right"><bean:message key="app.itempurchase.extendCost" /></th>        
    <th>&nbsp;</th>
    <th>&nbsp;</th>
  </tr>     
  <tr>
...
<logic:notEqual name="itemPurchaseListHeadForm" property="recordCount" value="0"> 
  ...
  <logic:iterate id="itemPurchaseForm"
	...
	<tr align="left" class="<%=currentColor %>">
	  <td>
            <bean:write name="itemPurchaseForm" property="invoiceYear" />
	  </td>
	  <td>
            <bean:write name="itemPurchaseForm" property="invoiceMonthName" />
	  </td>  
	  <td align="right">
	  ...
	  <td align="right">
            ...
            <bean:write name="itemPurchaseForm" property="useTaxCost" />
	  </td>         
	  <td align="right">
            <bean:message key="app.localeCurrency" />
            <bean:write name="itemPurchaseForm" property="handlingCost" />
	  </td>        
	  <td align="right">
            <bean:message key="app.localeCurrency" />
  ...
  <tr>
    ...
    <td align="right">
      <bean:write name="itemPurchaseListHeadForm" property="transactionTotal" />
    </td>
    <td align="right">
      <bean:message key="app.localeCurrency" />
      <bean:write name="itemPurchaseListHeadForm" property="useTaxTotal" />
    </td>     
    <td align="right">
      <bean:message key="app.localeCurrency" />
      <bean:write name="itemPurchaseListHeadForm" property="handlingTotal" />
    </td>    
    <td align="right">
      <bean:message key="app.localeCurrency" />
