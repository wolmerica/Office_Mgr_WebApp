/*
 * PromotionEditAction.java
 *
 * Created on February 21, 2009, 6:12 PM
 *
...
public class PromotionEditAction extends Action {
  ...
  private void updatePromotion(HttpServletRequest request,
    ...
    try {
      ...
      PromotionDO formDO = (PromotionDO) request.getSession().getAttribute("promotion");

//----------------------------------------------------------------------
// Prepare a SQL statement to update the promotion table.
//----------------------------------------------------------------------
      String query = "UPDATE promotion SET "
        ...
        ps.setString(2, formDO.getCategory());
        ps.setBoolean(3, formDO.getAllItemsId());
        ps.setBoolean(4, formDO.getAllServicesId());
        ps.setDate(5, new java.sql.Date(formDO.getStartDate().getTime()));
        ps.setDate(6, new java.sql.Date(formDO.getEndDate().getTime()));
        ps.setBigDecimal(7, formDO.getDiscountRate());
        ps.setString(8, formDO.getNoteLine1());
