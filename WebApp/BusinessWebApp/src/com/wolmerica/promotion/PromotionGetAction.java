/*
 * PromotionGetAction.java
 *
 * Created on February 21, 2009, 6:24 PM
 *
...
public class PromotionGetAction extends Action {
  ...
  private PromotionDO buildPromotionForm(HttpServletRequest request,
                                         Integer proKey)
   throws Exception, SQLException {
    ...
    try {
      ...
      if ( rs.next() ) {
        ...
        throw new Exception("Promotion " + proKey.toString() + " not found!");
      }
    }
...
//--------------------------------------------------------------------------------
        PromotionDO formDO = buildPromotionForm(request,
                                                theKey);
        formDO.setPermissionStatus(usToken);

        request.getSession().setAttribute("promotion", formDO);
        PromotionForm formStr = new PromotionForm();
