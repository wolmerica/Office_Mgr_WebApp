...
public class CustomerTypeEditAction extends Action {
  ...
  private void updateCustomerType(HttpServletRequest request, ActionForm form)
    ...
    try {
      ...
      ps.setByte(2, formDO.getPrecedence());
      ps.setBoolean(3, formDO.getBlueBookId());
      ps.setBoolean(4, formDO.getPriceSheetId());
      ps.setBoolean(5, formDO.getActiveId());
      ps.setInt(6, formDO.getSoldByKey());
      ps.setString(7, formDO.getAttributeToEntity());
      ps.setString(8, request.getSession().getAttribute("USERNAME").toString());
      ps.setByte(9, formDO.getKey());
      ps.executeUpdate();
    }
...
//--------------------------------------------------------------------------------
      ...
      updateCustomerType(request, form);
    }
    catch (Exception e) {
