...
public class CustomerAccountingForm extends MasterForm {
  ...
  public CustomerAccountingForm() {
    addRequiredFields(new String[] { "customerKey", "acctName",
