...
public class LedgerEditAction extends Action {
  ...
  private void updateLedger(HttpServletRequest request,
                              ActionForm form)
    ...
    try {
      ...
      String query = "UPDATE ledger SET "
                   + "customer_key=?,"
                   + "invoice_num=?,"
                   + "invoice_total=?, "
                   + "update_user=?,"
      ...
      ps.setString(2, formDO.getInvoiceNumber());
      ps.setBigDecimal(3, formDO.getInvoiceTotal());
