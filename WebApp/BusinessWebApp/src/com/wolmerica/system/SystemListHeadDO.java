...
public class SystemListHeadDO extends AbstractDO implements Serializable
{
  ...
  private ArrayList systemListForm;
  ...
  public void setSystemListForm(ArrayList systemList){
  this.systemListForm=systemList;
  }

  public ArrayList getSystemListForm(){
  return systemListForm;
  }
