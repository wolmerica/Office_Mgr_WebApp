...
public class ResourceEditAction extends Action {
...
//===========================================================================
// Prepare a SQL query to update a row into the resource table.
//===========================================================================
      String query = "UPDATE resource SET "
                   + "name=?,"
                   + "description=?,"              
                   + "update_user=?,"
      ...
      ps.setString(1, formDO.getResourceName());
      ps.setString(2, formDO.getDescription());
