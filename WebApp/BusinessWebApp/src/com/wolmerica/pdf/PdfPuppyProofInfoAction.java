...
public class PdfPuppyProofInfoAction extends Action {
...
//--------------------------------------------------------------------------------
        Integer pageNum = 0;
        Integer pageMax = new Integer(getPropertyService().getCustomerProperties(request,"puppy.proof.page"));
...
//--------------------------------------------------------------------------------
        chunk = new Chunk(getPropertyService().getCustomerProperties(request,"puppy.proof.title"), FontFactory.getFont(fontType, headerSize, Font.BOLD));
        cell = new PdfPCell(new Phrase(chunk));
        cell.setBorder(0);
        cell.setColspan(3);
        datatable.addCell(cell);
...
//--------------------------------------------------------------------------------
        chunk = new Chunk(getPropertyService().getCustomerProperties(request,"puppy.proof.date")
...
//--------------------------------------------------------------------------------
      ...
      int headerwidths[] = { 95 }; // percentage
      datatable.setWidths(headerwidths);
...
//--------------------------------------------------------------------------------
      ...
      String messageKey = "puppy.proof.page" + pageNum.toString() + ".count";
      String message = "";
      ...
      {
        messageKey = "puppy.proof.page" + pageNum + ".section" + messageCount;
