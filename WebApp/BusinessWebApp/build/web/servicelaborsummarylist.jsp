...
<!-- ServiceLabor History Summary by Date Range -->
    <td colspan = "7">
      <html:form action="ServiceLaborSummaryList.do">
  ...
  <tr align="left">
    <th><bean:message key="app.servicelabor.invoiceMonthName" /></th>
    <th><bean:message key="app.servicelabor.invoiceYear" /></th>    
    <th align="right"><bean:message key="app.servicelabor.transactionCnt" /></th>       
...
<logic:notEqual name="serviceLaborListHeadForm" property="recordCount" value="0"> 
  ...
  <logic:iterate id="serviceLaborForm"
	...
	<tr align="left" class="<%=currentColor %>">
	  <td>
            <bean:write name="serviceLaborForm" property="invoiceMonthName" />
	  </td>
	  <td>
            <bean:write name="serviceLaborForm" property="invoiceYear" />
	  </td>
	  <td align="right">
  ...
  <tr>
    ...
    <td align="right">
      <bean:write name="serviceLaborListHeadForm" property="transactionTotal" />
    </td>      
    <td align="right">
      <bean:message key="app.localeCurrency" />
