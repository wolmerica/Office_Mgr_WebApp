/*
 * CustomerEventListAction.java
 *
 * Created on September 28, 2006, 9:00 PM
 *
...
public class CustomerEventListAction extends Action {
  ...
  private ResourceInstanceListHeadForm getCustomerEventList(HttpServletRequest request,
                                                            Integer customerKey,
                                                            String fromDate,
                                                            String toDate,
                                                            Integer pageNo)
...
//--------------------------------------------------------------------------------
// Prepare an SQL query to retrieve the customer appointment records.
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
      ...
      while ( rs.next() ) {
        ...
        dtToDate = rs.getDate("start_date");
...
//--------------------------------------------------------------------------------
        workOrderRows = getScheduleService().getCustomerSchedule(request,
                                                                 conn,
                                                                 customerKey,
                                                                 dtToDate);
...
//--------------------------------------------------------------------------------
// Not necessary but we will leave it in place in case it can be useful.
//--------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------
//      UserStateKit userState = new UserStateKit();
//      userState.SessionInstanceValidate(request);
//      userState.SessionAttributeCleanUp(request);

      try {
//--------------------------------------------------------------------------------
// Instantiate a formDO object to populate formStr.
//--------------------------------------------------------------------------------
        ResourceInstanceListHeadForm formHStr = getCustomerEventList(request,
                                                                     theKey,
                                                                     fromDate,
                                                                     toDate,                                               
                                                                     pageNo);
