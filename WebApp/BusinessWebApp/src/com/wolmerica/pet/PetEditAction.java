 ...
 * PetEditAction.java
 *
 * Created on December 15, 2005, 01:50 PM
 *
...
public class PetEditAction extends Action {
  ...
  private void updatePet(HttpServletRequest request,
    ...
    try {
      ...
      ps.setString(2, formDO.getPetName());
      ps.setInt(3, formDO.getSpeciesKey());
      ps.setInt(4, formDO.getBreedKey());
