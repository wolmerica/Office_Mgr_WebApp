...
public class EmployeeEntryAction extends Action {
...
//--------------------------------------------------------------------------------
        EmployeeDO formDO = new EmployeeDO();
        formDO.setPermissionSlip(getPropertyService().getFeatureProperties("employee.permissionslip.default"));
