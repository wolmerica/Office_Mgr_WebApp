...
public class HelpPackageListAction extends Action {
  ...
  private HelpHeadDO getHelpPackageList(HttpServletRequest request)
...
//===========================================================================
      ...
      formHDO.setLevelKey(new Byte("1"));
...
//--------------------------------------------------------------------------------
      ...
      try {
        ...
        HelpHeadDO formHDO = getHelpPackageList(request);
