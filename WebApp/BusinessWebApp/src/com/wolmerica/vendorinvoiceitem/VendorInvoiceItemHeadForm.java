/*
 * VendorInvoiceItemHeadForm.java
 *
...
public class VendorInvoiceItemHeadForm extends MasterForm
{
  ...
  private ArrayList vendorInvoiceItemForm;

  public VendorInvoiceItemHeadForm() {
//    addRequiredFields(new String[] { "invoiceNumber", "vendorName" } );
  ...
  public void setVendorInvoiceItemForm(ArrayList vendorInvItem){
  this.vendorInvoiceItemForm=vendorInvItem;
  }

  public ArrayList getVendorInvoiceItemForm(){
  return vendorInvoiceItemForm;
  }
