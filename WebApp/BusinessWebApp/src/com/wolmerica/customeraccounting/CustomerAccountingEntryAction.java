/*
 * CustomerAccountingEntryAction.java
 *
...
public class CustomerAccountingEntryAction extends Action {
  ...
  private CustomerAccountingDO buildCustomerAccountingForm(HttpServletRequest request,
   ...
   throws Exception, SQLException {
    ...
    CustomerAccountingDO formDO = new CustomerAccountingDO();
...
//--------------------------------------------------------------------------------
      ...
      if (request.getParameter("key") != null) {
        if (!(request.getParameter("key").equalsIgnoreCase("")))
...
//--------------------------------------------------------------------------------
      CustomerAccountingDO formDO = buildCustomerAccountingForm(request,
                                                                theKey,
                                                                balanceAmount);
