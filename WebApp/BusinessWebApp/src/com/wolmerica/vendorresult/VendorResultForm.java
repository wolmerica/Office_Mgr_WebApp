...
public class VendorResultForm extends MasterForm {
  ...
  public VendorResultForm() {
    addRequiredFields(new String[] { "siteName", "receiveDate", 
                                     "receiveAssessionId", "testCode",
                                     "testName", "testValue"});
  }
