/*
 * ItemPurchaseDetailListAction.java
 *
...
public class ItemPurchaseDetailListAction extends Action {
...
//--------------------------------------------------------------------------------
      query = "SELECT vi.thekey,"
            ...
            + "pabi.size,"
            + "id.size_unit,"
            + "cii.order_qty, ((pabi.size/id.size)*(vii.first_cost - vii.variant_amount)) AS first_cost,"
            + "((pabi.size/id.size)*(vii.variant_amount)) AS variant_amount,"
            + "(cii.order_qty * ((pabi.size/id.size)*(vii.first_cost - vii.variant_amount))) AS extend_cost,"
            + "c.client_name "
...
//--------------------------------------------------------------------------------
      query = "SELECT vi.thekey,"
            ...
            + "id.size,"
            + "id.size_unit,"
            + "si.quantity AS order_qty,"
            + "(vii.first_cost - vii.variant_amount) AS first_cost,"
            + "vii.variant_amount AS variant_amount,"
            + "(si.quantity * (vii.first_cost - vii.variant_amount)) AS extend_cost,"
            + "c.client_name "
...
//                   + "AND id.report_id "
      ...
      query = query + "ORDER BY vi.invoice_date, vi.invoice_num";
      ...
      while ( rs.next() ) {
        ...
        itemPurchaseRow.setInvoiceKey(rs.getInt("thekey"));
        itemPurchaseRow.setInvoiceDate(rs.getDate("invoice_date"));
        itemPurchaseRow.setInvoiceNumber(rs.getString("invoice_num"));
        itemPurchaseRow.setBrandName(rs.getString("brand_name"));
        itemPurchaseRow.setGenericName(rs.getString("generic_name"));
        itemPurchaseRow.setSize(rs.getBigDecimal("size"));
        itemPurchaseRow.setSizeUnit(rs.getString("size_unit"));
        itemPurchaseRow.setOrderQty(rs.getShort("order_qty"));
        itemPurchaseRow.setTheCost(rs.getBigDecimal("first_cost"));
        itemPurchaseRow.setTheDiscount(rs.getBigDecimal("variant_amount"));  
