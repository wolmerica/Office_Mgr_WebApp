...
// Allow edits of events that are not aged more than 2880 hours (120 days).
//--------------------------------------------------------------------------------
      if (formDO.getStatusKey() != 8) {
        rightNow = Calendar.getInstance();
        rightNow.add(Calendar.HOUR, - 2880);
...
// 6) End TimeStamp
//--------------------------------------------------------------------------------
  public ArrayList<WorkOrderForm> getResourceSchedule(HttpServletRequest request,
                                       Connection conn,
                                       Integer woKey,
                                       Integer resourceKey,
...
// 5) Event Date
//--------------------------------------------------------------------------------
  public ArrayList<WorkOrderForm> getAttributeToSchedule(HttpServletRequest request,
                                          Connection conn,
                                          Byte sourceTypeKey,
                                          Integer sourceKey,
                                          Date startDate)
