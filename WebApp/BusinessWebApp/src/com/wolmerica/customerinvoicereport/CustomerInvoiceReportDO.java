...
public class CustomerInvoiceReportDO extends AbstractDO implements Serializable
{
  ...
  private Date dateOfService = new Date();
  ...
  private BigDecimal debitAdjustmentAmt = new BigDecimal("0");
  ...
  private BigDecimal creditAdjustmentAmt = new BigDecimal("0");
  ...
  public void setDebitAdjustmentAmt(BigDecimal debitAdjustmentAmt) {
    this.debitAdjustmentAmt = debitAdjustmentAmt;
  }

  public BigDecimal getDebitAdjustmentAmt(){
  ...
  public void setCreditAdjustmentAmt(BigDecimal creditAdjustmentAmt) {
    this.creditAdjustmentAmt = creditAdjustmentAmt;
  }

  public BigDecimal getCreditAdjustmentAmt(){
