...
public class SpeciesEditAction extends Action {
  ...
  private void updateSpecies(HttpServletRequest request,
                           ActionForm form)
...
//===========================================================================
// Prepare a SQL query to update a row into the species table.
//===========================================================================
      ...
      ps.setString(1, formDO.getSpeciesName());
