...
public class CustomerListHeadDO extends AbstractDO implements Serializable
{
  ...
  private ArrayList customerListForm;
  ...
  public void setCustomerListForm(ArrayList customerList){
  this.customerListForm=customerList;
  }

  public ArrayList getCustomerListForm(){
