/*
 * LogisticsDeleteAction.java
 *
 * Created on November 15, 2008  4:52 PM
 *
...
public class LogisticsDeleteAction extends Action {
  ...
  private void deleteLogistics(HttpServletRequest request,
                                Integer logKey)
    ...
    try {
      String query = "DELETE FROM logistics "
                   + "WHERE thekey=? ";
...
//--------------------------------------------------------------------------------
      ...
      if (usToken.equalsIgnoreCase(getUserStateService().getLocked()))
        deleteLogistics(request, theKey);
