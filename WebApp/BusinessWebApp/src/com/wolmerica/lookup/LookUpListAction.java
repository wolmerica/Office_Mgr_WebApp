...
public class LookUpListAction extends Action {
  ...
  private LookUpListHeadDO getLookUp(HttpServletRequest request,
    ...
    try {
      ...
      String query = "SELECT name, COUNT(*) AS lookUp_count "
                   + "FROM pet "
      ...
      while ( rs.next() ) {
        ...
        if ((recordCount >= firstRecord) && (recordCount <= lastRecord)) {
          ...
          lookUpRow.setLookUpCount(rs.getInt("lookUp_count"));
...
//--------------------------------------------------------------------------------
    ...
    try {
       ...
       try {
         ...
         LookUpListHeadDO formHDO = getLookUp(request,
                                            lookUpNameFilter,
                                            pageNo);
