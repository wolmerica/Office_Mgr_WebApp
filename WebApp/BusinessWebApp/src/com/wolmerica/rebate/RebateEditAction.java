/*
 * RebateEditAction.java
 *
 * Created on May 27, 2006, 11:18 AM
 *
...
public class RebateEditAction extends Action {
  ...
  private void updateRebate(HttpServletRequest request,
                            ActionForm form)
    ...
    try {
      ...
      String query = "UPDATE rebate SET "
                   + "submit_date=?,"
                   + "terms=?,"
                   + "address=?,"
                   + "address2=?,"
      ...
      ps.setDate(1, new java.sql.Date(formDO.getSubmitDate().getTime()));
      ps.setString(2, formDO.getTerms());
