/*
 * PriceByItemDeleteAction.java
 *
 * Created on November 16, 2005, 2:00 PM
 *
...
public class PriceByItemDeleteAction extends Action {
  ...
  private void deletePriceByItem(HttpServletRequest request,
                                   Integer idKey)
...
//--------------------------------------------------------------------------------
      ...
      if (usToken.equalsIgnoreCase(getUserStateService().getLocked()))
        deletePriceByItem(request, theKey);
