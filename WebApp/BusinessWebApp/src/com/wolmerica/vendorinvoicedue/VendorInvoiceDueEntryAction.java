/*
 * VendorInvoiceDueEntryAction.java
 *
 * Created on August 24, 2006, 5:05 PM
 *
...
public class VendorInvoiceDueEntryAction extends Action {
  ...
  private VendorInvoiceDueListHeadDO buildVendorInvoiceDueList(HttpServletRequest request)
   throws Exception, SQLException {

    VendorInvoiceDueListHeadDO formHDO = new VendorInvoiceDueListHeadDO();
...
//--------------------------------------------------------------------------------
        VendorInvoiceDueListHeadDO formHDO = buildVendorInvoiceDueList(request);
