...
public class PriceSheetListHeadDO extends AbstractDO implements Serializable
{
  ...
  public void setPriceSheetForm(ArrayList ledgerList){
  this.ledgerForm=ledgerList;
  }

  public ArrayList getPriceSheetForm(){
  return ledgerForm;
  }
}