...
public class PetBoardListHeadDO extends AbstractDO implements Serializable
{
  ...
  private ArrayList petBoardListForm;
  ...
  public void setPetBoardListForm(ArrayList petBoardList){
  this.petBoardListForm=petBoardList;
  }

  public ArrayList getPetBoardListForm(){
  return petBoardListForm;
  }
