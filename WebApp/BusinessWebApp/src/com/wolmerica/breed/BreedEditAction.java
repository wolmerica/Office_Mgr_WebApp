...
public class BreedEditAction extends Action {
  ...
  private void updateBreed(HttpServletRequest request,
                           ActionForm form)
...
//===========================================================================
// Prepare a SQL query to update a row into the breed table.
//===========================================================================
      ...
      ps.setInt(1, formDO.getSpeciesKey());
      ps.setString(2, formDO.getBreedName());
      ps.setString(3, formDO.getBreedExtId().toUpperCase());
